<?php
	...
	define('SITE_NAME' , "Employee Ettendance");
	...
	define('APP_ID',"b2e64c3341e7ec63d19aabd48032fa3b");
	...
	define('DB_PASSWORD','');
	define('DB_NAME','employeeattendance');
	...
	define('USER_EMAIL',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['Contactnumber'] : null ));
