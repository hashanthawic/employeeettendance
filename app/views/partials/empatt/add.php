    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 ">
                    <h3 class="record-title">Add New Empatt</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="empatt-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("empatt/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
