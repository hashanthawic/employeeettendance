    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container-fluid">
            ...
            <div class="row ">
                ...
                <div class="col-sm-4 ">
                    <h3 class="record-title">App Logs</h3>
                            ...
                            <nav class="page-header-breadcrumbs mt-2" aria-label="breadcrumb">
                                <ul class="breadcrumb m-0 p-1">
                                    ...
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('app_logs'); ?>">
                                    ...
                                    ?>
                                    <li class="breadcrumb-item">
                                        <a class="text-capitalize" href="<?php print_link('app_logs') ?>">Search</a>
                                    </li>
                                    ...
                                    <table class="table  table-striped table-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?php print_link("app_logs/$data[log_id]") ?>"><?php echo $data['log_id']; ?></a></td>
                                                ...
                                                <td> <?php echo $data['RecordID']; ?> </td>
                                                
                                                
                                                
                                                
                                                <td> <?php echo $data['SqlQuery']; ?> </td>
                                                ...
                                                <td> <?php echo $data['RequestUrl']; ?> </td>
                                                
                                                
                                                
                                                
                                                <td> <?php echo $data['RequestData']; ?> </td>
                                                
                                                
                                                
                                                
                                                <td> <?php echo $data['RequestCompleted']; ?> </td>
                                                
                                                
                                                
                                                
                                                <td> <?php echo $data['RequestMsg']; ?> </td>
